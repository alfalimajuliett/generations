...
class Biennial:
    ...
    def __init__(self, initial_seedbank=None, probability_of_decay=None, probability_of_germination=None, maximum_plant_fecundity=None, fecundity_to_biomass=None, seedling_survival_to_flowering=None, seed_incorporation_rate=None, damage_function_shape=None, weevil_population=None, weevil_attack_rate=None, larval_survival=None, initial_flower_population=None, seedling_survival_to_rosette=None, initial_rosette_population=None, rosette_survival=None, average_seed_per_plant=None, conversion_coefficient=None, percent_increase_mortality=None):
        ...
        self.probability_of_germination = probability_of_germination or 0.27
        self.maximum_plant_fecundity = maximum_plant_fecundity or 102
        ...
        self.weevil_population = weevil_population or 120
        ...
        self.conversion_coefficient = conversion_coefficient or 0.03 #conversion of plant matter to weevil's biomass? Need to run ECI for C. scrobicollis
        self.percent_increase_mortality = percent_increase_mortality or 0.43
    ...
    def flower(self, gen):
        ...
        if gen == 0:
            ...
            return self.rosette(gen-1)*self.rosette_survival*math.e**(-self.percent_increase_mortality*self.weevil(gen-1)/self.average_seed_per_plant)#multiply by rate of attrition of weevil from Buckley
    ...
    def weevil(self, gen):
        ...
        if gen == 0:
            ...
            return (self.larval_survival*self.weevil(gen-1)*self.rosette(gen-1))/self.rosette(gen) #*self.percent_increase_mortality)removed *self.probability_of_germination*self.seedling_survival_to_flowering
