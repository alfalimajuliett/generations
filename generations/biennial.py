...
class Biennial(BaseModel):
    ...
    def weevil(self, gen):
        ...
        if gen == 0:
            ...
            return self.rosette(gen-1)*self.weevil(gen-1)*attack_rate*weevil_survival #*self.percent_increase_mortality)removed *self.probability_of_germination*self.seedling_survival_to_flowering
